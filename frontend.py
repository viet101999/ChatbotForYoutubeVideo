...
def get_text():
    # text = st.text_input("Textbox", key="input_text", on_change=submit_text, placeholder="Ask a question about the video")
    input_text = st.text_input("Textbox", key="input_text", placeholder="Ask a question about the video")
    # print("st.session_state.last_input_text", st.session_state.last_input_text)
    # print("st.session_state.my_text", st.session_state.my_text)
